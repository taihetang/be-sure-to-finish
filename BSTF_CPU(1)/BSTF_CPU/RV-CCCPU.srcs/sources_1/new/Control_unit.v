...
module Control_unit(
    ...
    begin
        case(opcode)
            ...
            begin
                casez(funct3)
                    3'b000:     pc_Sel = (Comp_out == 2'b00) ? 1'b1 : 1'b0;  // beq
                    3'b001:     pc_Sel = ~(Comp_out == 2'b00) ? 1'b1 : 1'b0; // bne
                    3'b1?0:     pc_Sel = (Comp_out == 2'b01) ? 1'b1 : 1'b0;   // blt/bltu
                    3'b1?1:     pc_Sel = (Comp_out == 2'b10) ? 1'b1 : 1'b0;   // bge/bgeu
                    default:    pc_Sel = 1'b0;
                endcase
            end
            `jal:    pc_Sel = 1'b1;
    ...
    begin
        case (opcode)
            ...
            begin
                case (funct3)
                    3'b010:     rd1_pc_Sel = 1'b1;  // slti/sltiu
                    default:    rd1_pc_Sel = 1'b0;
                endcase
            end
            `jalr:   rd1_pc_Sel = 1'b1;
            `jal:    rd1_pc_Sel = 1'b1;
        ...
        case (opcode)
            ...
            begin
                case ({funct7[5], funct3})
                    4'b1101: unsigned_Sel = 1'b1;  // sra
                    4'b0011: unsigned_Sel = 1'b1;  // sltu
            ...
            begin
                case ({funct7[5], funct3})
                    4'b1101: unsigned_Sel = 1'b1;  // srai
                    4'b0011: unsigned_Sel = 1'b1;  // sltiu
                    default: unsigned_Sel = 1'b0;
                endcase
            end
            `load: 
