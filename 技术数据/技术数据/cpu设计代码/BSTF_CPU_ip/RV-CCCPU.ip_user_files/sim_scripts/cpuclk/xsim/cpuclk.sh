...
#
# Script generated by Vivado on Wed May 07 17:23:17 +0800 2025
...
#
# Usage        : cpuclk.sh
#                cpuclk.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cpuclk.sh [-reset_run]
#                cpuclk.sh [-reset_log]
#                cpuclk.sh [-help]
#
...
# script info
echo -e "cpuclk.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cpuclk.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cpuclk xil_defaultlib.cpuclk xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cpuclk.wdb xsim.dir libdpi.so)
...
Usage: cpuclk.sh [-step]\n\
Usage: cpuclk.sh [-lib_map_path]\n\
Usage: cpuclk.sh [-reset_run]\n\
Usage: cpuclk.sh [-reset_log]\n\
Usage: cpuclk.sh [-keep_index]\n\
