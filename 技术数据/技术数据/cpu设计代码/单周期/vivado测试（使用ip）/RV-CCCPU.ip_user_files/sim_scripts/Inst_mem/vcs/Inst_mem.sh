...
design_libs=(dist_mem_gen_v8_0_14 xil_defaultlib)
...
reset_run()
{
  files_to_remove=(ucli.key Inst_mem_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Inst_mem_simv.daidir vcs_lib c.obj)
