...
#
# Script generated by Vivado on Wed May 14 17:21:53 +0800 2025
...
#
# Usage        : Inst_mem.sh
#                Inst_mem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Inst_mem.sh [-reset_run]
#                Inst_mem.sh [-reset_log]
#                Inst_mem.sh [-help]
#
...
#                script (type 'Inst_mem.sh -help' for more information).
#
...
design_libs_elab="-libname dist_mem_gen_v8_0_14 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver dist_mem_gen_v8_0_14 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "Inst_mem.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Inst_mem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.Inst_mem xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.Inst_mem -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log Inst_mem_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: Inst_mem.sh [-step]\n\
Usage: Inst_mem.sh [-lib_map_path]\n\
Usage: Inst_mem.sh [-reset_run]\n\
Usage: Inst_mem.sh [-reset_log]\n\
Usage: Inst_mem.sh [-keep_index]\n\
